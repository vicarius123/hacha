/*
 * @link https://github.com/willdurand/BazingaJsTranslationBundle
 * @copyright William DURAND <william.durand1@gmail.com>
 */
...
(function (window) {
    ...
    function install (Vue) {
        ...
        Vue.prototype.$trans = window.Translator.trans;
        Vue.prototype.$transChoice = window.Translator.transChoice;

        Vue.filter('trans', function(id, parameters, domain, locale) {
            return window.Translator.trans(id, evalExp.call(this, parameters), evalExp.call(this, domain), evalExp.call(this, locale));
        });

        Vue.filter('transChoice', function(id, number, parameters, domain, locale) {
            return window.Translator.transChoice(id, evalExp.call(this, number) || 0, evalExp.call(this, parameters), evalExp.call(this, domain), evalExp.call(this, locale));
        });
