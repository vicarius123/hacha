...
JFactory::getDocument()->addScriptDeclaration('
	Joomla.submitbutton = function(task)
	{
		if (task == "article.cancel" || document.formvalidator.isValid(document.getElementById("item-form")))
		{
			...
			' . $this->form->getField('introtext')->save() . $this->form->getField('fulltext')->save() .'
		...
		<div class="row-fluid">
			<div class="span9">
				...
				<fieldset class="adminform">
					<h4>Преамбула: </h4><?php echo $this->form->getInput('introtext'); ?>
				</fieldset>
				<fieldset class="adminform">
					<h4>Текст: </h4><?php echo $this->form->getInput('fulltext'); ?>
				</fieldset>
				<fieldset class="adminform">
					<h4>Снизу сбоку: </h4><?php echo $this->form->getInput('right_ru'); ?>
				</fieldset>
				...
				<fieldset class="adminform">
					<h4>Заголовок: </h4><?php echo $this->form->getInput('title_en'); ?>
				</fieldset>
				<br>
				<fieldset class="adminform">
					<h4>Преамбула: </h4><?php echo $this->form->getInput('introtext_en'); ?>
				</fieldset>
				<fieldset class="adminform">
					<h4>Текст: </h4><?php echo $this->form->getInput('fulltext_en'); ?>
				</fieldset>
				<fieldset class="adminform">
					<h4>Снизу сбоку: </h4><?php echo $this->form->getInput('right_en'); ?>
				</fieldset>
				...
				<fieldset class="adminform">
					<h4>Slider: </h4><?php echo $this->form->getInput('slider'); ?>
				</fieldset>
