 ...
 * @since  1.6
 */
class HachaViewTags extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		HachaHelpersHacha::addSubmenu('tags');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_HACHA_TITLE_TAGS'), 'tags.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_hacha&view=tags');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`news_id`' => JText::_('COM_HACHA_TAGS_NEWS_ID'),
			'a.`newstag_id`' => JText::_('COM_HACHA_TAGS_NEWSTAG_ID'),
			'a.`ordering`' => JText::_('JGRID_HEADING_ORDERING'),
			'a.`state`' => JText::_('JSTATUS'),
			'a.`created_by`' => JText::_('COM_HACHA_TAGS_CREATED_BY'),
		);
	}
}
